...
--
-- Host: localhost
-- Generation Time: Mar 03, 2015 at 04:07 AM
...
('Hmmm', 1, 'self', 0, 341, '2015-02-14 19:03:27', 'nolvorite', 'Post?', 'post', '4bbed0e0b2', 1, NULL, NULL, 1, 0, NULL),
('Check', 2, 'n-a', 19, 351, '2015-02-14 21:48:09', 'nolvorite', '', '', 'f1313a306f', 1, 19, NULL, 1, 0, NULL),
('Check.', 2, 'n-a', 19, 352, '2015-02-14 21:49:42', 'nolvorite', '', '', '7332bd5480', 1, 19, NULL, 1, 0, NULL),
('Check.', 2, 'n-a', 19, 353, '2015-02-14 21:51:31', 'nolvorite', ' ', '_', 'c66d6e005d', 1, 19, NULL, 1, 0, NULL),
('hmmm_966add1115', 2, 'n-a', 350, 354, '2015-02-15 01:28:18', 'nolvorite', ' ', '_', 'e3ed6becb3', 1, 350, NULL, 1, 0, NULL),
('qqq', 3, 'nerd', NULL, 355, '2015-02-15 23:58:09', 'nolvorite', NULL, NULL, NULL, 2, NULL, NULL, 1, 0, 1),
('Check again', 2, 'n-a', 350, 356, '2015-02-16 00:38:20', 'nolvorite', ' ', '_', '25d78f73f0', 1, 350, NULL, 1, 0, NULL),
('Test', 0, 'self', 0, 358, '2015-02-22 23:36:51', 'nolvorite', 'Test', 'test', '56c6471e24', 1, NULL, NULL, 1, 0, NULL),
('Test', 0, 'self', 0, 359, '2015-02-22 23:38:02', 'nolvorite', 'Test', 'test', 'f892d99362', 1, NULL, NULL, 1, 0, NULL),
('icles', 1, 'secret_sam_harris_fanboy', 0, 375, '2015-02-23 23:30:28', 'nolvorite', 'Test', 'test', '26b7dad0b2', 1, NULL, NULL, 1, 0, NULL),
('Because some idiot used a ternary operator for string comparisons.', 1, 'self', 0, 376, '2015-02-28 06:38:36', 'nolvorite', '(One-liner) [Why did God kill an elephant?]', 'one-liner_why_did_god_kill_an_elephant', 'b6f23d618f', 1, NULL, NULL, 1, 0, NULL),
('Hmmm', 1, 'self', 0, 377, '2015-02-28 06:43:24', 'nolvorite', 'That took annoyingly long to post.', 'that_took_annoyingly_long_to_post', '28a69e4f24', 1, NULL, NULL, 1, 0, NULL),
('QFT', 3, 'nerd', NULL, 378, '2015-02-28 06:44:12', 'nolvorite', NULL, NULL, NULL, 2, NULL, NULL, 1, 0, 1),
('reply', 3, 'nerd', NULL, 379, '2015-03-01 03:10:49', 'nolvorite', NULL, NULL, NULL, 2, NULL, NULL, 1, 0, 1),
('psst', 3, 'nerd', NULL, 380, '2015-03-02 00:39:29', 'nolvorite', NULL, NULL, NULL, 2, NULL, NULL, 1, 0, 1),
('eh', 3, 'nerd', NULL, 381, '2015-03-02 00:47:05', 'nolvorite', NULL, NULL, NULL, 2, NULL, NULL, 1, 0, 1),
('ur 4evr alone', 3, 'nolvorite', NULL, 382, '2015-03-02 00:54:50', 'nerd', NULL, NULL, NULL, 2, NULL, NULL, 1, 0, 1),
('Is it the case that the server takes so long, or this is really poorly coded?', 3, 'nerd', NULL, 383, '2015-03-02 00:59:19', 'nolvorite', NULL, NULL, NULL, 2, NULL, NULL, 1, 0, 1),
('I&#39;ll bet on the latter. This computer is shit', 3, 'nerd', NULL, 384, '2015-03-02 01:01:13', 'nolvorite', NULL, NULL, NULL, 2, NULL, NULL, 1, 0, 1),
('You mean former', 3, 'nolvorite', NULL, 385, '2015-03-02 01:05:47', 'nerd', NULL, NULL, NULL, 2, NULL, NULL, 1, 0, 1),
('I think i&#39;ve resolved all lag issues now.', 3, 'nolvorite', NULL, 386, '2015-03-02 03:28:55', 'nerd', NULL, NULL, NULL, 2, NULL, NULL, 1, 0, 1),
('Now let&#39;s check to see if the reply reloads after a post', 3, 'nolvorite', NULL, 387, '2015-03-02 03:54:21', 'nerd', NULL, NULL, NULL, 2, NULL, NULL, 1, 0, 1),
('Test', 3, 'nolvorite', NULL, 388, '2015-03-02 03:57:36', 'nerd', NULL, NULL, NULL, 2, NULL, NULL, 1, 0, 1),
('This should work now.', 3, 'nolvorite', NULL, 389, '2015-03-02 04:00:03', 'nerd', NULL, NULL, NULL, 2, NULL, NULL, 1, 0, 1),
('Test', 2, 'n-a', 19, 390, '2015-03-03 03:39:56', 'nolvorite', ' ', '_', 'a2928e4ef8', 1, 19, NULL, 1, 0, NULL),
('Woot', 3, 'nerd', NULL, 391, '2015-03-03 04:04:02', 'nolvorite', NULL, NULL, NULL, 2, NULL, NULL, 1, 0, 0);
...
CREATE TABLE IF NOT EXISTS `sg_permissions` (
  ...
  `posting_rights` varchar(10) NOT NULL DEFAULT 'both',
  PRIMARY KEY (`sgp_id`)
...
INSERT INTO `sg_permissions` (`access_type`, `towhom`, `date_g`, `granted_by`, `sgp_id`, `posting_rights`) VALUES
('friend snowglobe', 'nolvorite', '2014-12-16 00:00:00', 'nerd', 1, 'both'),
('friend snowglobe', 'nerd', '2014-12-17 00:00:00', 'nolvorite', 2, 'both'),
('friend snowglobe', 'nolvorite', '0000-00-00 00:00:00', 'nolvorite', 3, 'both'),
('friend snowglobe', 'test_user4aaaasd', '0000-00-00 00:00:00', 'test_user4aaaasd', 4, 'both'),
('friend snowglobe', 'test_9', '0000-00-00 00:00:00', 'test_9', 5, 'both'),
('friend snowglobe', 'asdasdas', '0000-00-00 00:00:00', 'asdasdas', 6, 'both'),
('friend snowglobe', 'nerd', '0000-00-00 00:00:00', 'nerd', 7, 'both'),
('root admin', 'nolvorite', '2015-02-13 13:22:53', 'anything_at_all', 8, 'both'),
('root admin', 'nolvorite', '2015-02-18 20:57:11', 'something_else', 9, 'both'),
('root admin', 'nolvorite', '2015-02-19 15:45:46', 'secret_sam_harris_fanboy', 10, 'both');
...
CREATE TABLE IF NOT EXISTS `snowglobes` (
  ...
  `followers` int(11) NOT NULL DEFAULT '1',
  `no_threads` int(11) DEFAULT '0',
...
INSERT INTO `snowglobes` (`sg_id`, `sg_name`, `description`, `root_admin_id`, `sg_url`, `sg_privacy`, `is_finished_being_modified`, `creation_date`, `followers`, `no_threads`, `no_replies`, `motto`) VALUES
(1, 'Anything at all', '', 1, 'anything_at_all', 'private', '0', '2015-02-10 00:08:03', 1, 0, 0, NULL),
(2, 'Something else', 'What hence the man to do to the crow? What ought he to do? Ought he to love? To die? To see? To sing? Oh friends, come with me on this journey. Come to the arduous cave and fight the crow and the wildebeest. Doth nothing forget the flee?', 1, 'something_else', 'public', '0', '2015-02-18 20:57:11', 1, 0, 0, ''),
(3, 'Secret Sam Harris Fanboy Society', 'DAE Morality don&#39;t real without stem? QED??? Free will don&#39;t real because neuroscience? DAE Fuck David Hume???', 1, 'secret_sam_harris_fanboy', 'private', '0', '2015-02-19 15:45:46', 1, 0, 0, '');
...
('nolvorite', 'd83ab46b4325d8bcd1102188c38d8a098b23a168', 1, 'hns_marcon@hotmail.com', 1, '2014-11-14 23:52:34', 'Hans Marcon', 'on', '1', 4, 9, 1996, '6c478c525f517a7ab838', '0', '2015-02-06 22:18:40', '2015-03-02 22:04:15', NULL, '["nerd"]'),
...
('nerd', '0989807af1ccfc712499519ebcb0e742b0597918', NULL, 'nerd@nerd.nerd', 36, '2014-12-14 22:10:24', 'John Hammercock', 'on', NULL, 6, 5, 1976, '9f5106ab7ebfe0e42b9a', '0', '2014-12-17 21:26:35', '2015-03-02 00:12:21', NULL, '["nolvorite"]');
...
('nolvorite', '2015-02-27 18:22:39', 341, 1, 301),
('nolvorite', '2015-02-23 17:30:29', 375, 1, 302),
('nolvorite', '2015-02-28 00:38:41', 376, 1, 303),
('nolvorite', '2015-02-28 00:43:28', 377, 1, 304);
