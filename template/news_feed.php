...
if(news_feed_check){     
    if(isset($_SESSION['salt_q']) && compare_dz($_SESSION['salt_q'],$logged_dt['salt'])){     //personal news feed      
        ...
        while($que_own = mysqli_fetch_assoc($que_posts[0])){
            ...
            //image posts
              ...
              <a href='thread/".$que_own['thread_nick']."_".$que_own['topic_hash']."' class='topic_link'>".time_rounds($que_own['stamptime'])."</a>
              <span class='score'> (".$score."%)</span>";
              echo "<span class='votes'><a href='up' class='vote_" .$select_class[0] . "'><img src='".$main_dir."template/img/up.png'></a>
              <a href='down' class='vote_" .$select_class[1] . "'><img src='".$main_dir."template/img/down.png'></a></span></span>
              </td></tr></table></div>";
        };       
